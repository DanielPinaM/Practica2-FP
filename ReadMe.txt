========================================================================
    APLICACIÓN DE CONSOLA: SolucionComprobacion Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación SolucionComprobacion.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación SolucionComprobacion.


SolucionComprobacion.vcxproj
...
SolucionComprobacion.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado SolucionComprobacion.pch y un archivo de tipos precompilados llamado StdAfx.obj.
